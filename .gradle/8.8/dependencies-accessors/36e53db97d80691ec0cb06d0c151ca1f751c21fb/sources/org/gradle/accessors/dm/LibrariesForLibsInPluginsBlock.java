...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final WebrtcLibraryAccessors laccForWebrtcLibraryAccessors = new WebrtcLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>webrtc</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public WebrtcLibraryAccessors getWebrtc() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForWebrtcLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class WebrtcLibraryAccessors extends SubDependencyFactory {

        public WebrtcLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>peerconnection</b> with <b>org.webrtc:google-webrtc</b> coordinates and
         * with version reference <b>webrtc</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getPeerconnection() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("webrtc.peerconnection");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>webrtc</b> with value <b>1.0.32006</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWebrtc() { return getVersion("webrtc"); }
    ...
    public static class JetbrainsKotlinPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>jetbrains.kotlin.multiplatform</b> with plugin id <b>org.jetbrains.kotlin.multiplatform</b> and
         * with version reference <b>kotlin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getMultiplatform() { return createPlugin("jetbrains.kotlin.multiplatform"); }
